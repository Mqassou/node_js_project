  ...
  return DB.accessor.query(sql).then(() => {
    return request(app).put('/alliances/' + putAlliance.parameters.id).send(putAlliance.body).then(res => {
      ...
      t.deepEqual(_rec14._expr(_rec14._capt(_rec14._capt(res, 'arguments/0/object').body, 'arguments/0'), {
        content: 't.deepEqual(res.body, putAlliance.result)',
        filepath: 'tests\\alliances-tests.js',
        line: 83,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[12,15]},"property":{"type":"Identifier","name":"body","range":[16,20]},"computed":false,"range":[12,20]},{"type":"MemberExpression","object":{"type":"Identifier","name":"putAlliance","range":[22,33]},"property":{"type":"Identifier","name":"result","range":[34,40]},"computed":false,"range":[22,40]}],"range":[0,41]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"deepEqual","range":[2,11]},{"type":{"label":"("},"range":[11,12]},{"type":{"label":"name"},"value":"res","range":[12,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"body","range":[16,20]},{"type":{"label":","},"range":[20,21]},{"type":{"label":"name"},"value":"putAlliance","range":[22,33]},{"type":{"label":"."},"range":[33,34]},{"type":{"label":"name"},"value":"result","range":[34,40]},{"type":{"label":")"},"range":[40,41]}]',
        visitorKeys: _powerAssertVisitorKeys
      }), _rec15._expr(_rec15._capt(_rec15._capt(putAlliance, 'arguments/1/object').result, 'arguments/1'), {
        content: 't.deepEqual(res.body, putAlliance.result)',
        filepath: 'tests\\alliances-tests.js',
        line: 83,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"deepEqual","range":[2,11]},"computed":false,"range":[0,11]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"res","range":[12,15]},"property":{"type":"Identifier","name":"body","range":[16,20]},"computed":false,"range":[12,20]},{"type":"MemberExpression","object":{"type":"Identifier","name":"putAlliance","range":[22,33]},"property":{"type":"Identifier","name":"result","range":[34,40]},"computed":false,"range":[22,40]}],"range":[0,41]}',
...
//# sourceMappingURL=..\node_modules\.cache\ava\79bf140752c0f2eb8054794ae7b00e30.js.map